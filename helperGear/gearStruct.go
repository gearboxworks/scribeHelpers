...
//type GearConfig *gearConfig.GearConfig


func NewGear(runtime *helperRuntime.TypeRuntime) *Gear {
	var gear Gear
...
func NewGearConfig(runtime *helperRuntime.TypeRuntime) *gearConfig.GearConfig {
...
//func (gear *Gear) EnsureNotNil(runtime *helperRuntime.TypeRuntime) *Gear {
//	if state := ux.IfNilReturnError(gear); state.IsError() {
//		return &Gear{State: state}
//	}
//
//	for range OnlyOnce {
//		gear.State = gear.State.EnsureNotNil()
...
//
//	for range OnlyOnce {
//		gear.State = ux.NewState(gear.Runtime.CmdName, gear.Debug)
//
//		if gear.Docker == nil {
//			gear.Docker = helperDocker.New(runtime)
//			if gear.Docker.State.IsError() {
//				gear.State.SetError("can not connect to Docker service provider")
//				break
//			}
//		}
